...
public class Converter {
    ...
    public static void SByteToBits(sbyte value, byte[] array, int startBit) {
        ByteToBits((byte)value, array, startBit);
    }
    ...
    public static sbyte SByteFromBits(byte[] array, int startBit) {
        return (sbyte)ByteFromBits(array, startBit);
    }
    ...
    public static byte ByteFromBits(ulong[] array, int startBit) {
        return (byte)FromBits(BitsPerByte, array, startBit);
    }
    ...
    public static void FromShort(short value, byte[] array, int startIndex) {
        FromUShort((ushort)value, array, startIndex);
    }
    ...
    public static short ToShort(byte[] array, int startIndex) {
        return (short)ToUShort(array, startIndex);
    }
    ...
    public static void ShortToBits(short value, byte[] array, int startBit) {
        UShortToBits((ushort)value, array, startBit);
    }
    ...
    public static void UShortToBits(ushort value, ulong[] array, int startBit) {
        ToBits(value, sizeof(ushort) * BitsPerByte, array, startBit);
    }
    ...
    public static short ShortFromBits(byte[] array, int startBit) {
        return (short)UShortFromBits(array, startBit);
    }
    ...
    public static ushort UShortFromBits(ulong[] array, int startBit) {
        return (ushort)FromBits(sizeof(ushort) * BitsPerByte, array, startBit);
    }
    ...
    public static void FromInt(int value, byte[] array, int startIndex) {
        FromUInt((uint)value, array, startIndex);
    }
    ...
    public static int ToInt(byte[] array, int startIndex) {
        return (int)ToUInt(array, startIndex);
    }
    ...
    public static void IntToBits(int value, byte[] array, int startBit) {
        UIntToBits((uint)value, array, startBit);
    }
    ...
    public static void UIntToBits(uint value, ulong[] array, int startBit) {
        ToBits(value, sizeof(uint) * BitsPerByte, array, startBit);
    }
    ...
    public static int IntFromBits(byte[] array, int startBit) {
        return (int)UIntFromBits(array, startBit);
    }
    ...
    public static uint UIntFromBits(ulong[] array, int startBit) {
        return (uint)FromBits(sizeof(uint) * BitsPerByte, array, startBit);
    }
    ...
    public static void FromLong(long value, byte[] array, int startIndex) {
        FromULong((ulong)value, array, startIndex);
    }
    ...
    public static void LongToBits(long value, byte[] array, int startBit) {
        ULongToBits((ulong)value, array, startBit);
    }
    ...
    /// <returns>The converted <see cref="long"/>.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static long LongFromBits(byte[] array, int startBit) {
        return (long)ULongFromBits(array, startBit);
    }

    /// <inheritdoc cref="LongFromBits(byte[], int)"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static long LongFromBits(ulong[] array, int startBit) {
        return (long)ULongFromBits(array, startBit);
    }
    ...
    public static void FromFloat(float value, byte[] array, int startIndex) {
        FloatConverter converter = new() { FloatValue = value };
#if BIG_ENDIAN
    ...
    public static void FromDouble(double value, byte[] array, int startIndex) {
        DoubleConverter converter = new() { DoubleValue = value };
#if BIG_ENDIAN
