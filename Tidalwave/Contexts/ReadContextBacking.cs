...
namespace Tidalwave {
    public ref partial struct ReadContext {
        ...
        private bool _PeakBool() { return PeakBit(); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private byte _PeakByte() { return (byte)PeakBits(TypeBitSizes.ByteSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private sbyte _PeakSByte() { return (sbyte)PeakBits(TypeBitSizes.SByteSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private short _PeakShort() { return (short)PeakBits(TypeBitSizes.ShortSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private ushort _PeakUShort() { return (ushort)PeakBits(TypeBitSizes.UShortSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private int _PeakInt() { return (int)PeakBits(TypeBitSizes.IntSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private uint _PeakUInt() { return (uint)PeakBits(TypeBitSizes.UIntSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private long _PeakLong() { return (long)PeakBits(TypeBitSizes.LongSize); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private ulong _PeakULong() { return PeakBits(TypeBitSizes.ULongSize); }
        ...
        private float _PeakFloat() {
            uint intValue = (uint)PeakBits(TypeBitSizes.FloatSize);
        ...
        private double _PeakDouble() {
            ulong longValue = PeakBits(TypeBitSizes.DoubleSize);
